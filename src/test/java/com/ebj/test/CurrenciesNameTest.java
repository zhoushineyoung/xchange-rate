...
public class CurrenciesNameTest {
    public static void main(String[] args) {
        ...
        System.out.println(Joiner.on(",").join(nameSet2));
    ...
    @Test
    public void name() {
        String[] names = AllCurrencies.getAllCurrencyNames();
        System.out.println(names.length + " [" + Joiner.on(",").join(names) + "].");
        System.out.println("**************************");
